...
Public Class clsTicket
    ...
    Private Sub FACTURA(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        If Len(Comprobante.Locador.Nombre) > 20 Then
            e.Graphics.DrawString(Comprobante.Locador.Nombre, printFont, Brushes.Black, MargenIzquierdo, 30)
        Else
            e.Graphics.DrawString(Comprobante.Locador.Nombre, fuenteGrande, Brushes.Black, MargenIzquierdo, 30)
        End If

        yPos = 60

        e.Graphics.DrawString(Comprobante.Locador.Domicilio, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString(Comprobante.Locador.Localidad & "-" & Comprobante.Locador.Provincia, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString("Telefono: " & Comprobante.Locador.Telefono, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString("Tipo Iva: " & Comprobante.Locador.IVA.TipoIVA, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString("CUIT: " & Comprobante.Locador.Documento.Numero, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString("Ing.Btos: " & Comprobante.Locador.IB, printFont, Brushes.Black, MargenIzquierdo, yPos)
        yPos += IncrementoYPreTexto
        e.Graphics.DrawString("Inicio Actividades: " & Comprobante.Locador.InicioActividad, printFont, Brushes.Black, MargenIzquierdo, yPos)
        ...
        If Me.Comprobante.TipoComprobante.Letra = "A" Then
            ...
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("Imp.Neto 21%: " & StrDup(28 - Len(strImpNeto1), " ") & strImpNeto1, printFont, Brushes.Black, MargenIzquierdo, yPos)

            strIVA1 = Format(Comprobante.ImpIVA1, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("I.V.A 21%: " & StrDup(31 - Len(strIVA1), " ") & strIVA1, printFont, Brushes.Black, MargenIzquierdo, yPos)

            strImpNeto2 = Format(Comprobante.ImpNeto2, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("Imp.Neto 10,5%: " & StrDup(26 - Len(strImpNeto2), " ") & strImpNeto2, printFont, Brushes.Black, MargenIzquierdo, yPos)

            strIVA2 = Format(Comprobante.ImpIVA2, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("I.V.A 10,5%: " & StrDup(29 - Len(strIVA2), " ") & strIVA2, printFont, Brushes.Black, MargenIzquierdo, yPos)
    ...
    Public Sub Imprimir(ByVal argCopia As String)
        ...
        Select Case Comprobante.TipoComprobante.CodiTC_SiCoFa
            Case "FAA", "FAB", "FAC", "NCA", "NCB", "NCC", "NCX", "RECR", "PRESU", "RTO", "DI"
