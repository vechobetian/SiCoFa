...
Public Class clsReporteRecibo
    ...
    Property CantidadEnLetras As String
    ...
    Public Sub Run(ByVal argTipoReporte As String)
        ...
        report.DataSources.Add(New ReportDataSource("Encabezado", Me.Encabezado))
        report.DataSources.Add(New ReportDataSource("TipoComprobante", Me.TipoComprobante))
