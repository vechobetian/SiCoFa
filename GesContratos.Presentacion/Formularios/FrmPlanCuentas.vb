...
Public Class FrmPlanCuentas
    Private mobj_NAdminPlanCuentas As New cls_N_AdminPlanCuentas
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim nodo_raiz As TreeNode
        nodo_raiz = Me.TreeView1.Nodes.Add(0, "Rubros Contables")

        For Each r As RubroContabilidad In mobj_NAdminPlanCuentas.Rubros
    ...
    Private Sub CargarSubRubros(ByVal argCodiRub As String, ByVal n As TreeNode)
        For Each sr As SubRubroContabilidad In mobj_NAdminPlanCuentas.SubRubros(argCodiRub)
    ...
    Private Sub CargarCuentasColectivas(ByVal argCodiSubRub As String, ByVal n As TreeNode)
        For Each cc As CuentaColectiva In mobj_NAdminPlanCuentas.CuentasColectivas(argCodiSubRub)
    ...
    Private Sub CargarCuentasImputables(ByVal argCodiCtaCol As String, ByVal n As TreeNode)
        For Each ci As CuentaImputable In mobj_NAdminPlanCuentas.CuentasImputables(argCodiCtaCol)
