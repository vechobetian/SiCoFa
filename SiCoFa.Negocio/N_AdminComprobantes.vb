    ...
    Private Sub GenerarQR(ByRef argComprobante As Comprobante)
        ...
        Try
            If argComprobante.CAE IsNot Nothing Then
                ...
                argComprobante.QR = New QRCompE(argComprobante.FechaComp, CUIT, PVta, argComprobante.TipoComprobante.CodiTC_ARCA, NumComp, argComprobante.ImpBto, argComprobante.Cliente.Documento.TipoDocumento.CodiTDAFIP, CLng(argComprobante.Cliente.Documento.Numero), CLng(argComprobante.CAE.NumCAE))
