...
Public Class FrmNotaCredito
    ...
    Private Sub Guardar()
        Try
            ...
            argImpBto:=Me.mdec_ImporteSinDescuentos,
            argImpDes:=Me.mdec_ImporteDescuentos,
            argImpNeto:=Me.mdec_ImporteConDescuentos,
            argImpEx:=0,
        ...
        Try
            ...
            For Each i As ItemComprobanteNC In mobj_ItemsComprobanteOrigen
                If i.CantidadNC > 0 Then
                    ...
                    Dim objItemComprobante As New ItemComprobante(i.IdItem, i.IdArticulo, i.CodBarras, i.Descripcion, i.Fraccionado, i.CantidadNC, i.AlicIVA, i.PrecioCosto, i.PrecioUnitario, i.DescuentoUnitario, i.PorcentajeDescuento)
