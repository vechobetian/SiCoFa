...
Public Class FrmSecciones
    ...
    Private mAdminSecciones As New N_AdminSecciones
    ...
    Private Sub BuscarSeccion(ByVal argTextoBuscado As String)
        ...
        Try
            ...
            Dim ls As List(Of Seccion) = mAdminSecciones.ListarSecciones(argTextoBuscado)
    ...
    Private Sub Guardar_Click(sender As Object, e As EventArgs) Handles Guardar.Click
        Try
            ...
            If Me.NuevaSeccion = True Then
                ...
                Dim IdSeccion As String = mAdminSecciones.InsertarSecciones(Me.Seccion.Text, establecer_precio)
                If IdSeccion <> "" Then
            ...
            Else
                ...
                Dim establecer_precio As Boolean = If(Me.EstablecerPrecio.SelectedItem.ToString() = "SI", True, False)
                Dim Actualizado As Boolean = mAdminSecciones.ActualizarSeccion(Me.IdSeccion.Text, Me.Seccion.Text, establecer_precio)
