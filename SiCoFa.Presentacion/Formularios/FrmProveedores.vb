...
Public Class FrmProveedores
    ...
    Private Sub MostrarProveedor(ByVal argProveedor As Proveedor)
        ...
        Try
            With Me
                .TxtId.Text = argProveedor.Id.ToString
                ...
                .UcTipoDoc.Id = argProveedor.Documento.TipoDocumento.CodiTD
                .TxtNumDoc.Text = argProveedor.Documento.Numero
                .TxtFechaAlta.Text = argProveedor.FechaAlta.ToString("dd/MM/yyyy")
    ...
    Public Overrides Sub Guardar_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If Me.NuevaPersona = True Then
                Dim Id As Integer = mAdminProveedores.InsertarProveedor(Me.TxtNombre.Text, Me.TxtDomicilio.Text, Me.TxtLocalidad.Text, Me.UcProvincia.Descripcion, Me.TxtTelefono.Text, Me.TxtEmail.Text, Me.UcTipoDoc.Id.ToString, Me.TxtNumDoc.Text)
                If Id > 0 Then
            ...
            Else
                ...
                Dim Actualizado As Boolean = mAdminProveedores.ActualizarProveedor(CInt(Me.TxtId.Text), Me.TxtDomicilio.Text, Me.TxtLocalidad.Text, Me.UcProvincia.Descripcion, Me.TxtTelefono.Text, Me.TxtEmail.Text, Me.UcTipoDoc.Id.ToString, Me.TxtNumDoc.Text, "", Me.UcEstado.Descripcion)
