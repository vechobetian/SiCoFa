...
Public Class FrmSelectorUniversal
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        Select Case e.KeyCode
            ...
            Case Keys.Enter
                e.Handled = True
                e.SuppressKeyPress = True ' evita beep y que pase al próximo control
                ...
                If Me.DataGridView1.CurrentRow IsNot Nothing Then
                    ...
                    If objetoSeleccionado IsNot Nothing Then
                        If TypeOf objetoSeleccionado Is DataRowView Then
                            ' Si es un DataRowView (de un DataTable), accedemos por nombre de columna
                            Dim drv As DataRowView = DirectCast(objetoSeleccionado, DataRowView)
                            m_Valor1Seleccionado = drv(NombrePropiedadId)
                            m_Valor2Seleccionado = drv(NombrePropiedadDescripcion)
                        Else
                            ' Si es una clase con propiedades públicas, usamos reflexión
