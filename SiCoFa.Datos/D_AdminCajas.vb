...
Public Class D_AdminCajas
    ...
    Public Function RetiroEfectivoCajaAbiertaTransaccion(ByVal argMacAddress As String, ByVal argCaja As Caja, ByVal argEmpresa As Empresa, ByVal argUsuario As Usuario, ByVal argComprobante As Comprobante) As Boolean
