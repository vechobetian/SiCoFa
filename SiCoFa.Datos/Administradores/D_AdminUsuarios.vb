...
Public Class D_AdminUsuarios
    Public Function ObtenerUsuarioPorId(ByVal argIdUsuario As Integer) As Usuario
        ...
        Try
            Dim sql As String = "SELECT IdUsuario,Nombre,Domicilio,Localidad,Provincia,Telefono,Email,CodiTD,NumDoc,FechaAlta,Estado FROM usuarios WHERE IdUsuario=@IdUsuario"
    ...
    Public Function ListarUsuarios(ByVal argTextoBuscado As String) As List(Of Usuario)
        ...
        Try
            ...
            If argTextoBuscado = "*" Then
                sql = "SELECT IdUsuario,Nombre,Domicilio,Localidad,Provincia,Telefono,Email,CodiTD,NumDoc,FechaAlta,Estado,Password FROM usuarios ORDER BY Nombre"
            Else
                sql = "SELECT IdUsuario,Nombre,Domicilio,Localidad,Provincia,Telefono,Email,CodiTD,NumDoc,FechaAlta,Estado,Password FROM usuarios WHERE Nombre LIKE @Nombre ORDER BY Nombre"
            End If
