        ...
        Try
            ...
            Using cmd As New MySqlCommand("sp_insertar_receta", cn, tx) With {.CommandType = CommandType.StoredProcedure}
                With cmd.Parameters
                    ...
                    .Add("p_NumDoc", MySqlDbType.VarChar).Value = If(argReceta.Documento Is Nothing, CObj(DBNull.Value), argReceta.Documento.Numero)
                    .Add("p_Credencial", MySqlDbType.VarChar).Value = If(argReceta.Credencial Is Nothing, CObj(DBNull.Value), argReceta.Credencial.Numero)
                    .Add("p_Nombre", MySqlDbType.VarChar).Value = If(argReceta.Credencial Is Nothing, CObj(DBNull.Value), argReceta.Credencial.Nombre)
                    .Add("p_CodiTM", MySqlDbType.VarChar).Value = If(argReceta.Prescriptor Is Nothing, CObj(DBNull.Value), argReceta.Prescriptor.Matricula.TipoMatricula.CodiTM)
                    .Add("p_CodiP", MySqlDbType.VarChar).Value = If(argReceta.Prescriptor Is Nothing, CObj(DBNull.Value), argReceta.Prescriptor.Provincia.CodiP)
                    .Add("p_CodiTP", MySqlDbType.VarChar).Value = If(argReceta.Prescriptor Is Nothing, CObj(DBNull.Value), argReceta.Prescriptor.TipoPrescriptor.CodiTP)
                    .Add("p_NumMatricula", MySqlDbType.VarChar).Value = If(argReceta.Prescriptor Is Nothing, CObj(DBNull.Value), argReceta.Prescriptor.Matricula.Numero)
                    ...
                    .Add("p_NumAutorizacion", MySqlDbType.VarChar).Value = If(String.IsNullOrEmpty(argReceta.NumAutorizacion), CObj(DBNull.Value), argReceta.NumAutorizacion)
